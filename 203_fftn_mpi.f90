...
! ---
do j = 1, nynpy
    call dfftw_execute_dft_r2c(plan_xf, in(:,j), in_hat_x(:,j))       ! 1D real to complex FFT in x direction
end do
...
do j = 1, nynpy
    call dfftw_execute_dft_c2r(plan_xb, in_hat_x(:,j), out(:,j))       ! 1D real to complex FFT in x direction
end do
! ---
